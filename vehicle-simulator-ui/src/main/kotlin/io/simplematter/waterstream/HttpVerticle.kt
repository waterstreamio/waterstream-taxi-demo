...
class HttpVerticle : CoroutineVerticle() {
  ...
  override suspend fun start() {
    ...
    router.get().handler { ctx: RoutingContext ->
      val data = JsonObject()
        .put("messageCountPanelAddress", config.messageCountPanelAddress)
        .put("messageCountPanelLink", config.messageCountPanelLink)
        .put("taxisStatsPanelAddress", config.taxisStatsPanelAddress)
